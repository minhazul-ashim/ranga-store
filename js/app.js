...
/*Function for showing all products in the UI. The parameter is an array of objects*/
...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p class='text-info product-rating'>Average Rating: <strong>${product.rating.rate}</strong></p>
...
/*Function for adding products in the cart. This function is called directly from the html by onclick() method. The parameter are passed from the html which are the id of the product and it's price;*/
...
/*Common Function for extracting the input value from html. Parameter required. The parameter is the target html id;*/
...
/*Function for updating the price in the UI. Parameters required. The first parameter is the target HTML id and the second parameter is the value to update;*/
...
/*Common Function for setting the innertext in html. Parameters Required. First parameter is the target html id and second parameter is the value to set; */

const setInnerText = (id, value) => {
  document.getElementById(id).innerText = value.toFixed(2);
};

/* Function for updating the tax charge. No parameters required. The value is extracted straight from DOM to calculate the tax; */
...
/* Function for updating the grandtotal. Parameters not required, The values are extracted straight from DOM.; */
